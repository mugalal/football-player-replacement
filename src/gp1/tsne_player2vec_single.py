...
OUTPUT_FIG = "models/gp1/single_token/tsne_player2vec_single.png"
...
# remove dominant component (same processing to compare fairly)
...
plt.title("t-SNE of Player2Vec (Single-token)")
plt.tight_layout()
